...
const VOICE_ID = "JBFqnCBsd6RMkjVDRZzb"; // George — deep, authoritative British male
...
serve(async (req) => {
  ...
  try {
    const ELEVENLABS_API_KEY = Deno.env.get("ELEVENLABS_API_KEY_V2") || Deno.env.get("ELEVENLABS_API_KEY");
