  ...
  return (
    <div className="px-4 sm:px-6 py-16 md:py-24">
      <div className="rounded-2xl mx-auto p-10 md:p-14 text-center" style={{ maxWidth: 672, background: "hsl(var(--secondary))", border: "1px solid hsl(var(--border))" }}>
        <h3 className="text-2xl md:text-3xl font-bold mb-4" style={{ color: "hsl(var(--text-primary))" }}>Ready to make a better call?</h3>
        <p className="text-base mb-8" style={{ color: "hsl(var(--text-secondary))" }}>Your next big decision deserves more than instinct.</p>
