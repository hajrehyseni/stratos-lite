          ...
          <div className="w-full" style={{ maxWidth: 400 }}>
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4">
              <input
                ...
                className="w-full rounded-lg px-4 outline-none transition-colors focus:border-primary/40"
                style={inputStyle}
              />
              <input
              ...
              <div className="space-y-4 mb-8">
                {benefits.map((b) => (
                  <div key={b} className="flex items-start gap-3">
                    <span className="mt-0.5" style={{ color: "hsl(var(--primary))" }}>✓</span>
                    <span className="text-sm" style={{ color: "hsl(var(--foreground))" }}>{b}</span>
                  </div>
                ))}
              </div>

              {/* Mini scorecard mockup — hidden on mobile */}
              <div className="hidden sm:block rounded-xl p-5 opacity-60" style={{ background: "#0A0A0A", border: "1px solid rgba(255,255,255,0.05)" }}>
                <div className="flex items-baseline gap-1 mb-2">
                  <span className="text-2xl font-bold" style={{ color: "hsl(var(--primary))" }}>72</span>
